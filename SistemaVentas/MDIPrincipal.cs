...
namespace SistemaVentas
{
    public partial class MDIPrincipal : Form
    {
        ...
        {
            sslUsuario.Text = "UNÍ-RUPAP 2023 || " + "ID Usuario: "+ idUsuario + " || Usuario: " + nomUsuario;
            MessageBox.Show("Bienvenido: " + this.nomUsuario, "SAIV", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void sslUsuario_Click(object sender, EventArgs e)
        {
